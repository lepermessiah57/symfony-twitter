...
use Lepermessiah\TwitterBundle\Entity\Users;
use Lepermessiah\TwitterBundle\Form\UsersType;
...
class UsersController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LepermessiahTwitterBundle:Users')->findAll();
     ...
     * @Method("POST")
     * @Template("LepermessiahTwitterBundle:Users:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LepermessiahTwitterBundle:Users')->find($id);
     ...
     * @Method("PUT")
     * @Template("LepermessiahTwitterBundle:Users:edit.html.twig")
     */
